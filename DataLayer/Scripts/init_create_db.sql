...
/****** Object:  Database [flashcards]    Script Date: 1/30/2026 1:38:06 AM ******/
CREATE DATABASE [flashcards]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'flashcards', FILENAME = N'/var/opt/mssql/data/flashcards.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'flashcards_log', FILENAME = N'/var/opt/mssql/data/flashcards_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
